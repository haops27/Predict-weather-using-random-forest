...
def load_weather_data():
    files = [
        'datasets-main/hanoi 2014-2016.csv',
        'datasets-main/hanoi 2016-2018.csv',
        'datasets-main/hanoi 2018-2020.csv',
        'datasets-main/hanoi 2020-2022.csv',
        'datasets-main/hanoi 2022-2025.csv'
    ]
